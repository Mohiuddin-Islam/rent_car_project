<?php
  ...
  if(isset($_POST['update_user']))
    {
        extract($_POST);
            $query="UPDATE tms_user SET u_fname='$u_fname', u_lname='$u_lname', u_phone='$u_phone', u_addr='$u_addr', u_category='$u_category', u_email='$u_email', u_pwd='$u_pwd' where u_id='$aid'";
      ...
      <?php if(isset($succ)) {?>
        ...
        <div class="card-body">
          ...
          <?php
            ...
            $res="SELECT * FROM tms_user WHERE u_id='$aid'";
            $sq1= $mysqli->query($res) ;
            
            //$cnt=1;
            while($row=$sq1->fetch_object())
        {
        ?>
          <form method ="POST"> 
